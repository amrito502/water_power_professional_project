    ...
    <div class="row">
        <div class="col-md-12 col-12 col-lg-12">
            <div class="card px-3 py-4">
                ...
                <div class="url_page">
                    <p style="font-size: 15px;font-weight: 400;margin-bottom: 0px;"><a href="{{ url('/') }}">Home</a> / HR / Manage Department</p>
                    <a href="{{ route('departments.create') }}" style="float: right;" class="btn btn-info">Add Department</a>
                </div>
            </div>
            <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btn" style="display: flex;justify-content: center;align-items: center;width: 100%;">
                                            <a style="font-size: 17px;margin-right: 16px;color: #ffffff;" class="btn btn-warning" href="{{ route('departments.edit', $item->id) }}">Edit</a>
