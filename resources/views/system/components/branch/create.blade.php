...
@section('content')
    <div class="row">
        <div class="col-md-12 col-12 col-lg-12">
            <div class="card px-3 py-4">
                ...
                <div class="url_page">
                    <p style="font-size: 15px;font-weight: 400;margin-bottom: 0px;">
                        <a href="{{ url('/') }}">Home</a> / Settings / Manage Company / Add Branch
                    </p>
            ...
            <div class="card p-5">
                <form action="{{ route('branches.store') }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" id="name" placeholder="Branch Name" class="form-control py-2 mt-3">
                    </div>
